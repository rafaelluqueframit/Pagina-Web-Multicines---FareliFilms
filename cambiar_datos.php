...
<body>
    ...
    <header>
        ...
        if(isset($_SESSION['username']) && $_SESSION['rol'] !== 'admin') {
            $navLink = '<li><a href="cambiar_datos.php">Cambiar datos personales</a></li>';
        } else {
            $navLink = '';
        }
        ?>
    ...
    <main>   
        ...
        <section id="sectionAlta">
            <article id="titAlta"><h2 class="titulosBody">Formulario Actualizar Datos</h2></article>
            <form id="formAlta" action="gestor_cambiar_datos.php" method="POST">
                ...
                <input class="inputAlta" type="text" pattern="^[^']*?$" id="username" name="username" required>
                ...
                <h4 class="mensaje">Gracias por actualizar tus datos.</h4>
                <!--<div id="error"></div>-->
            </form>
        </section>
        <script>
