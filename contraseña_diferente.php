...
<body>
    ...
    <main>
        ...
        <section id="sectionDadoAlta">
            <article id="titDadoAlta"><h2 class="titulosBody">Contraseñas Diferentes</h2></article>
            <article id="dadoAlta1">¡El usuario no ha sido dado de alta!</article>
            <article id="dadoAlta2">Las contraseñas deben ser iguales.</article>
            <article id="logCine" ><a id="noAñadida" href="altausuarios.php">Volver al registro</article>
        </section>
