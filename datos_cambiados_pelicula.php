...
<body>
    ...
    <main>
        ...
        <section id="sectionDadoAlta">
            <article id="titDadoAlta"><h2 class="titulosBody">Datos Cambiados Pelicula</h2></article>
            <article id="dadoAlta1">Los datos de la película han sido cambiados correctamente.</article>
            <article id="dadoAlta2">Bienvenido a FARELI FILMS</article>
            <article id="logCine" ><a href="index.php"><img src="imagenes/FareliFilms.jpg" alt="Logo del cine" ></a></article>
        </section>
