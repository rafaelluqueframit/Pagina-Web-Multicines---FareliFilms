...
<body>
    ...
    <main>   
        ...
        <section id="sectionAdmin">
            <article id="titAdmin1"><h2 class="titulosBody">Gestionar Peliculas</h2></article>
            <article id="titAdmin2"><a href="añadirPeli.php" class="titulosAdmin">Añadir Pelicula</a></article>
            <article id="titAdmin3"><a href="modificarPeli.php" class="titulosAdmin">Modificar Peliculas</a></article>
            <article id="titAdmin4"><a href="eliminarPeli.php" class="titulosAdmin">Eliminar Peliculas</a></article>
            <a>
        </section>
