...
<body>
    ...
    <main>   
        ...
        <section id="sectionAlta">
            <article id="titAlta"><h2 class="titulosBody">Formulario Actualizar Datos Peliculas</h2></article>
            <form id="formAlta" action="gestor_cambiar_datos_peliculas.php" method="POST">

                <label class="labelAlta" for="tituloAntiguo">Elija que película actualizar (*):</label>
                <select id="valoracion" name="tituloAntiguo" required>
                ...
                // Consultar las películas en la tabla
                ...
                <br><br><label class="labelAlta" for="tituloNuevo">Título Nuevo (*) (Máximo 80 caracteres):</label>
                <input class="inputAlta" type="text" id="tituloNuevo" pattern="^[^']*?$" strlen() maxlength="80" name="tituloNuevo" required>
                ...
                <h4 class="mensaje">Gracias por actualizar la película.</h4>
