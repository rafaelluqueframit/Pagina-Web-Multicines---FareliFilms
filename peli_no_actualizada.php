...
<html lang="es">
    <head>
        ...
        window.onload = function() {
            var errorMessage = "<?php session_start(); echo isset($_SESSION['error_message']) ? $_SESSION['error_message'] : ''; ?>";
...
<body>
    ...
    <main>
        ...
        <section id="sectionDadoAlta">
            <article id="titDadoAlta"><h2 class="titulosBody">Película NO Actualizada</h2></article>
            <article id="dadoAlta1">¡La película NO ha sido actualizada!</article>
            <article id="dadoAlta2">El título de la película ya existe.</article>
            <article id="logCine" ><a id="noAñadida" href="modificarPeli.php">Volver al registro</article>
        </section>
