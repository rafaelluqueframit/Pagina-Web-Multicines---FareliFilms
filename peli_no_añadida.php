...
<body>
    ...
    <main>
        ...
        <section id="sectionDadoAlta">
            <article id="titDadoAlta"><h2 class="titulosBody">Película NO Añadida</h2></article>
            <article id="dadoAlta1">¡La película NO ha sido añadida!</article>
            <article id="dadoAlta2">El título de la película ya existe.</article>
            <article id="logCine" ><a id="noAñadida" href="añadirPeli.php">Volver al registro</article>
        </section>
