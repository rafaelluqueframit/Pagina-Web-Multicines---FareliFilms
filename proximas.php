...
<body>
    ...
    <main>
        ...
        <div class="sectionEstrenos">
            <article class="articleTitulo">
                <h2 class="tituloEstrenos">Próximas en exhibición</h2>
            </article>
            ...
            <?php
                    ...
                    $consulta = "SELECT * FROM peliculas WHERE categoria = 'Proximas en exhibicion';";
                    $resultado = $conexion->query($consulta);
                    ...
                    if ($resultado->num_rows > 0) {
                        for ($i = 0; $i < $resultado->num_rows; $i++) {
                            ...
                            echo '<div class="movie"><article class="movie_info">';
                            echo '<a href="peli.php?titulo=' . $fila['titulo'] . '"><h2 class="titPeli">' . $fila['titulo'] . '</h2></a> ';
                            echo '<p class="infoPeli">' . $fila['titulo'] . ' | ' . $fila['director'] . ' | ' . $fila['fecha'] . '&#128198 | ' . $fila['tiempo'] . '&#9200</p>';
                            echo '<p class="infoPeli">(Intérpretes) ' . $fila['interpretes'] . '</p>';
                            echo '<p class="infoPeli">' . $fila['valoracionMedia'] . '</p></article>';
                            echo '<article class="cuadroPeliculas"><a href="peli.php?titulo=' . $fila['titulo'] . '">';
                            echo '<img src = "' . $fila['direccionFoto1'] . '" alt = "Peli1"/></a></article></div>';
                        }
                    } else {
