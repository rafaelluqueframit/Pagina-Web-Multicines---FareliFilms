...
<body>
    ...
    <main>
        ...
        <section id="sectionDadoAlta">
            <article id="titDadoAlta"><h2 class="titulosBody">Usuario NO Actualizado</h2></article>
            <article id="dadoAlta1">¡El usuario NO ha sido actualizado!</article>
            <article id="dadoAlta2">El username ya existe</article>
            <article id="logCine" ><a id="noAñadida" href="cambiar_datos.php">Volver al registro</article>
        </section>
